...
export default function MinimartInventory() {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      // Skip image field for inventory — only need stock/name/sku/category
      const res = await axiosInstance.get(`${API}/products?noImage=true`);
  ...
  async function handleStockChange() {
    ...
    try {
      await axiosInstance.patch(endpoint, { quantity: amount });
