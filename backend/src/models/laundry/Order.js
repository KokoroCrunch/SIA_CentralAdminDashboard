...
const LaundryOrderSchema = new mongoose.Schema(
  {
    customer: { type: mongoose.Schema.Types.ObjectId, ref: 'LaundryCustomer', required: true },
...
async function getModel() {
  ...
  _model = conn.models['LaundryOrder'] || conn.model('LaundryOrder', LaundryOrderSchema);
  return _model;
}
